        ...
        */
        ...
        static function image($element)
        {
            if (empty($element['data'])) {
                ...
                } elseif ($element['show_options'] == true) {
         ...
         * @return string|false
         */
        public static function select_hierarchical_post_types(array $element, $post_type = 'page')
        {
            $defaults = array(
                                'id'                => '',
                                'std'               => array( '', 0 ),
            ...
            $element['post_status'] = array_map(function ($value) {
                $value = trim($value);
                return $value;
            }, $post_status);
         ...
         * @return string
         */
        public static function handler_wp_list_pages($title, WP_Post $page)
        {
         ...
         * @return string|false
         */
        public static function select_hierarchical_taxonomy(array $element, $taxonomy = 'category')
        {
            $defaults = array(
                                'id'                => '',
                                'std'               => array( '', 0 ),
...
//                      'value_field'           => 'term_id',
        ...
        static function select($element)
        {
            ...
            if ($element['subtype'] == 'cat') {
                ...
                if (isset(AviaHtmlHelper::$cache['entry_' . $limit]) && isset(AviaHtmlHelper::$cache['entry_' . $limit][$element['subtype']])) {
                    ...
                    $post_status = array_map(function ($value) {
                        $value = trim($value);
                        return "'{$value}'";
                    }, $post_status);
        ...
        static function create_select_option($element, $entries, $fake_val, $parents, $level)
        {
            ...
            foreach ($entries as $key => $entry) {
                ...
                if (!empty($title) || (isset($title) && $title === 0)) {
                    ...
                    } elseif (strpos($title, 'close_option_group_') === 0) {
                        $output .= "</optgroup>";
                    } else {
         ...
         * @return string $output the string returned contains the html code generated within the method
         */
        public static function gmap_adress($element)
        {
            $defaults = array(
                            'address'   => '',
                            'postcode'  => '',
