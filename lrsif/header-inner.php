...
<header style="background-image:url('<?php echo $image[0]; ?>');background-size: cover; background-position: center center;" data-image-src="<?php echo $image[0]; ?>" data-parallax="scroll" class="parallax-window" id="<?php echo $post->post_name; ?>">
