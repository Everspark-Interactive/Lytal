...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		...
		'name'          => __( 'Address And Map', 'twentysixteen' ),
	...
	register_sidebar( array(
		...
		'name'          => __( 'Footer Text', 'twentysixteen' ),
...
function shortcode_google_review( $atts ){
 
 try {
$url = "http://testimonials.nr4.me/tv2.aspx?corporateId=497&styleId=4515&guid=6f4d9aa2-ff81-11e2-a675-00185195e385&fadeEvents=&fadeInterval=&fadeTime=&height=600&languageId=&bodyOnly=y";
return str_replace('<div style="position:relative;">',' ',file_get_contents($url)) ;
} catch (Exception $e) {
    return 'Caught exception: '.  $e->getMessage(). "\n";
}

}
add_shortcode( 'google-review', 'shortcode_google_review' );
